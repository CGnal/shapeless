...
object UnwrappedExamples {
  ...
  // you're using shapelezz, there's a good chance that one of the things you're
  ...
  // shapelezz-generated codecs that aren't practical?!? Just kidding, everything's
