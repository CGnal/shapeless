...
class CoproductTests {
  ...
  def testUnify {
    ...
    // See https://github.com/milessabin/shapelezz/issues/242
  ...
  def testRemoveElem {
    ...
    // See https://github.com/milessabin/shapelezz/issues/251
  ...
  def testEmbedDeembed {
    ...
    // See https://github.com/milessabin/shapelezz/issues/253
    illTyped("Coproduct[S5](3).embed[S1]")

    // See https://github.com/milessabin/shapelezz/issues/253#issuecomment-59648119
    {
...
package CoproductTestAux {
  // See https://github.com/milessabin/shapelezz/issues/328
  case class Foo(msg: String)
  case class Bar(msg: String)
