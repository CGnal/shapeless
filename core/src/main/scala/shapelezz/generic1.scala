...
class Generic1Macros(val c: whitebox.Context) extends CaseClassMacros {
  ...
  def mkProductGeneric1(tpe: Type, frTpe: Type): Tree = {
    ...
    q"""
      ...
      final class $clsName extends _root_.shapelezz.Generic1[$tpe, $frTpe] {
        type R[$nme] = $reprTpt

        def mkFrr: Apply1[$frTpe, R] = _root_.shapelezz.lazily[Apply1[$frTpe, R]]
      ...
      new $clsName(): _root_.shapelezz.Generic1.Aux[$tpe, $frTpe, $rnme]
    """
  }
  ...
  def mkCoproductGeneric1(tpe: Type, frTpe: Type): Tree = {
    ...
    val to = {
      ...
      q"""_root_.shapelezz.Coproduct.unsafeMkCoproduct((ft: Any) match { case ..$toCases }, ft).asInstanceOf[R[$nme]]"""
    }
    ...
    q"""
      ...
      final class $clsName extends _root_.shapelezz.Generic1[$tpe, $frTpe] {
        ...
        def from[$nme](rt: R[$nme]): Apply0[$tpe, $nme] = _root_.shapelezz.Coproduct.unsafeGet(rt).asInstanceOf[Apply0[$tpe, $nme]]
      }
      type $rnme[$nme] = $reprTpt
      new $clsName(): _root_.shapelezz.Generic1.Aux[$tpe, $frTpe, $rnme]
    """
...
class IsHCons1Macros(val c: whitebox.Context) extends IsCons1Macros {
  ...
  val isCons1TC: Tree = tq"_root_.shapelezz.IsHCons1"
  val consTpe: Type = hconsTpe

  def mkPackUnpack(nme: TypeName, lTpt: Tree, hdTpt: Tree, tlTpt: Tree): (Tree, Tree) =
    (
      q"""
        def pack[$nme](u: ($hdTpt, $tlTpt)): $lTpt = _root_.shapelezz.::(u._1, u._2)
      """,
      q"""
...
class IsCCons1Macros(val c: whitebox.Context) extends IsCons1Macros {
  ...
  val isCons1TC: Tree = tq"_root_.shapelezz.IsCCons1"
    ...
    (
      q"""
        def pack[$nme](u: _root_.scala.Either[$hdTpt, $tlTpt]): $lTpt = u match {
          case _root_.scala.Left(hd) => _root_.shapelezz.Inl[$hdTpt, $tlTpt](hd)
          case _root_.scala.Right(tl) => _root_.shapelezz.Inr[$hdTpt, $tlTpt](tl)
        }
      """,
      q"""
        def unpack[$nme](p: $lTpt): _root_.scala.Either[$hdTpt, $tlTpt] = p match {
          case _root_.shapelezz.Inl(hd) => _root_.scala.Left[$hdTpt, $tlTpt](hd)
          case _root_.shapelezz.Inr(tl) => _root_.scala.Right[$hdTpt, $tlTpt](tl)
        }
      """
    )
}
  ...
  def mkIsCons1(lTpe: Type, fhTpe0: Type, ftTpe0: Type): Tree = {
    ...
    q"""
      ...
      new $isCons1TC[$lTpe, $fhTpe, $ftTpe] {
        ...
        def mkFhh: Apply1[$fhTpe, H] = _root_.shapelezz.lazily[Apply1[$fhTpe, H]]
        def mkFtt: Apply1[$ftTpe, T] = _root_.shapelezz.lazily[Apply1[$ftTpe, T]]
...
class Split1Macros(val c: whitebox.Context) extends CaseClassMacros {
  ...
  def mkSplit1Impl[L[_], FO[_[_]], FI[_[_]]]
    ...
    q"""
      ...
      new _root_.shapelezz.Split1[$lTpe, $foTpe, $fiTpe] {
        type O[$nme] = $oTpt
        type I[$nme] = $iTpt

        def mkFoo: Apply1[$foTpe, O] = _root_.shapelezz.lazily[Apply1[$foTpe, O]]
        def mkFii: Apply1[$fiTpe, I] = _root_.shapelezz.lazily[Apply1[$fiTpe, I]]
