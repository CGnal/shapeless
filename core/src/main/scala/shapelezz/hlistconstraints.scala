 ...
 */
@implicitNotFound("Implicit not found: shapelezz.NotContainsConstraint[${L}, ${U}]. This HList already contains element of type ${U}.")
 ...
 */
@implicitNotFound("Implicit not found: shapelezz.IsDistinctConstraint[${L}]. Some elements have the same type.")
