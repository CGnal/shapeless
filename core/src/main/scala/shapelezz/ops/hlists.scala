...
object hlist {
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Last[${L}]. ${L} is empty, so there is no last element.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Init[${L}]. {L} is empty, so there is no first element.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Selector[${L}, ${U}]. You requested an element of type ${U}, but there is none in the HList ${L}.")
  ...
  /**
    ...
    * Simplified version of shapelezz.ops.record.SelectAll
    *
   ...
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.SelectMany[${L}, ${Ids}]. You requested the elements in ${Ids}, but HList ${L} does not contain all of them.")
   ...
   * @author Andreas Koestler
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.SelectRange[${L}, ${A}, ${B}]. You requested the elements in range [${A},${B}[, but HList ${L} does not contain all of them.")
  ...
  object SelectRange {
    ...
    (implicit range: shapelezz.ops.nat.Range.Aux[A, B, Ids], sel: SelectMany[L, Ids]): Aux[L, A, B, sel.Out] =
 ...
 trait Grouper[L <: HList, N <: Nat, Step <: Nat] extends DepFn1[L] with Serializable {
   ...
   * @author Stacy Curl
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Remove[${L}, ${E}]. You requested to remove an element of type ${E}, but there is no unique candidate in the HList ${L}.")
   ...
   * @author Stacy Curl
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.RemoveAll[${L}, ${SL}]. You requested to remove elements of the types ${SL}, but not all were found in HList ${L}.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Replacer[${L}, ${U}, ${V}]. You requested to replace an element of the type ${U}, but there is none in HList ${L}.")
   ...
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Modifier[${L}, ${U}, ${V}]. You requested to modify an element of the type ${U}, but there is none in HList ${L}.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.ReplaceAt[${L}, ${N}, ${V}]. You requested to modify an element at the position ${N}, but the HList ${L} is too short.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.At[${L}, ${N}]. You requested to access an element at the position ${N}, but the HList ${L} is too short.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Drop[${L}, ${N}]. You requested to drop an element at the position ${N}, but the HList ${L} is too short.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Take[${L}, ${N}]. You requested to take ${N} elements, but the HList ${L} is too short.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.Split[${L}, ${N}]. You requested to split at position ${N}, but the HList ${L} is too short.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.ReverseSplit[${L}, ${N}]. You requested to split at position ${N}, but the HList ${L} is too short.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.SplitLeft[${L}, ${U}]. You requested to split at an element of type ${U}, but there is none in the HList ${L}.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.ReverseSplitLeft[${L}, ${U}]. You requested to split at an element of type ${U}, but there is none in the HList ${L}.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.SplitRight[${L}, ${U}]. You requested to split at an element of type ${U}, but there is none in the HList ${L}.")
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.ReverseSplitRight[${L}, ${U}]. You requested to split at an element of type ${U}, but there is none in the HList ${L}.")
  ...
  trait LowPriorityPrepend extends LowestPriorityPrepend {
     ...
     * This one is for https://github.com/milessabin/shapelezz/issues/406
     */
   ...
   * @author Miles Sabin
   */
  @implicitNotFound("Implicit not found: shapelezz.Ops.ZipApply[${FL}, ${AL}]. The types of ${FL} and ${AL} are not compatible.")
