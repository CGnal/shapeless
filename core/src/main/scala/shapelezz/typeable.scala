  ...
  def dfltTypeableImpl[T: WeakTypeTag]: Tree = {
    ...
    dealiased match {
      ...
      case SingletonSymbolType(c) =>
        ...
        q"""_root_.shapelezz.Typeable.referenceSingletonTypeable[$tpe]($sym, $name, serializable = true)"""
      ...
      case RefinedType(parents, decls) =>
        ...
        q"""
          _root_.shapelezz.Typeable.intersectionTypeable(
            _root_.scala.Array[_root_.shapelezz.Typeable[_]](..$parentTypeables)
          )
         """
      ...
      case pTpe if pTpe.typeArgs.nonEmpty =>
        ...
        q"""
          _root_.shapelezz.Typeable.caseClassTypeable(
            classOf[$tpe], _root_.scala.Array[_root_.shapelezz.Typeable[_]](..$fieldTypeables)
          )
         """

      case SingleType(_, v) if !v.isParameter =>
        val name = v.name.toString
        q"""_root_.shapelezz.Typeable.referenceSingletonTypeable[$tpe]($v.asInstanceOf[$tpe], $name, serializable = ${v.isModule})"""

      case ConstantType(c) =>
        val name = c.tpe.typeSymbol.name.toString
        q"""_root_.shapelezz.Typeable.valueSingletonTypeable[$tpe]($c.asInstanceOf[$tpe], $name)"""

      case other =>
        q"""_root_.shapelezz.Typeable.simpleTypeable(classOf[$tpe])"""
    }
  }
}
